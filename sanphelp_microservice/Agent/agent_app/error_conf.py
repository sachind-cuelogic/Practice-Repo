...
## Coupon Management
BU_NAME_ALREADY_EXISTS = {
    "msg": "BU Name Already Exist",
    "error_code": 2003
}

BU_CODE_ALREADY_EXISTS = {
    "msg": "BU Code Already Exist",
    "error_code": 2004
}

FUNCTIONAL_GROUP_NAME_ALREADY_EXISTS = {
    "msg": "Functional Group Already Exist",
    "error_code": 2005
}
...
ACCOUNT_NAME_ALREADY_EXISTS = {
    "msg": "Account With This Name Already Exist",
    "error_code": 2006
}

ACCOUNT_CODE_ALREADY_EXISTS = {
    "msg": "Account With This Code Already Exist",
    "error_code": 2007
}

BU_UNIT_NOT_PROVIDED = {
    "msg": "BU Unit Is Not Provided",
    "error_code": 2008
}

USER_IS_DISABLED_BY_ADMIN = {
    "msg": "User Is Currently Disabled.",
    "error_code": 2009
}
